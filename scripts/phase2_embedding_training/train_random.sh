#!/bin/bash
#
# Train catELMo embedding model on random-selected 10% subset
#

set -e  # Exit on error

echo "========================================"
echo "catELMo Training - Random Selection"
echo "========================================"
echo ""
...
TRAIN_DATA="$PROJECT_ROOT/data/formatted_for_catelmo/selection/tcr_random_10pct.txt"
SAVE_DIR="$PROJECT_ROOT/models/embeddings/random_10pct"
...
# Run training
python train_elmo_fast_random.py \
    --save_dir "$SAVE_DIR" \
